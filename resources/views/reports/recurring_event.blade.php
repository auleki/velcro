    ...
    <div class="container col-md-6 events">
        ...
        <div class="nav">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link" href="/scheduled_event">One-time</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="#">Recurring</a>
                  </li>
              </ul>
        </div>
        <div class="row mt-5">
            <p class="ml-3 mt-2"> At: </p>
             <select name="" id="" class="form-control ml-3" style="width: 7rem">
                 <option value="" selected> Monthly</option>
             </select>
            <p class="ml-3 mt-2"> Every: </p>
            <input type="number" class="ml-3 form-control" placeholder="4">
            <p class="ml-3 mt-2"> Month </p>
