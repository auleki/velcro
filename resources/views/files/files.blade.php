               ...
               <div class="empty text-center">
                <svg width="400" height="300" viewBox="0 0 162 124" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="row d-flex justify-content-center">
                    <div class="dropdown">
                      <a href="#" class="btn btn-primary upload-btn text-white  mb-1" id="computer" data-target="#modalCenter" type="button">
                        Upload File
                      </a>

                      {{--  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                        <small class="ml-1 text-secondary">Upload file from </small>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger text-light "  style="color: #333333" class="close" data-dismiss="modal" aria-label="Close">Cancel</button>
      </div>
    </div>
  </div>
</div>
