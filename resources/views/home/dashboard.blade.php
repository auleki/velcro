                ...
                <svg width="400" height="300" viewBox="0 0 151 115" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect width="151" height="115" fill="white"/>
                     ...
                     <div class="text-center">
                      ...
                      <p class=" media-screens" >Put together a personal dashboard consisting of metrics that matter to you</p>
                      <a class="btn btn-primary" href="#!" data-toggle="modal" data-target="#addModal">Create Dashboard</a>
                   </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalCenterTitle">Name your dashboard</h5>
                    ...
                    <div class="modal-body">
                        <form action="/create-dashboard" method="post">
                            @csrf
                            <input type="text" class="form-control" placeholder="" name="dashboard">
