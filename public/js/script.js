...
var base = new Airtable({ apiKey: "FILL_OUT_API_KEY" }).base(
    "FILL_OUT_BASE_ID"
);
    ...
    base("Artists").create(
        {
            Name: "Al Held",
            Bio:
                "Al Held began his painting career by exhibiting Abstract Expressionist works in New York; he later turned to hard-edged geometric paintings that were ...",
            Genre: ["American Abstract Expressionism", "Color Field"],
            "On Display?": true
        },
        function(err, record) {
            if (err) {
